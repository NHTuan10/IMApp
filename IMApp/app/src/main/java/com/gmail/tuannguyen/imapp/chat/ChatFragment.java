...
public class ChatFragment extends Fragment {
    ...
    private static final String ARG_PARAM1 = "sender";
    ...
    // TODO: Change sender, receiver to real users
    private String sender;
    private String receiver = "test1";
    private static ChatMessagesAdapter chatMessagesAdapter = null;
    // TODO: OnFragmentInteractionListener mListener;
    ...
    public void sendTextMessage(View view) {
        EditText msgEditText = (EditText) view.findViewById(R.id.message_edit_text);
        String msgText = msgEditText.getText().toString();
        Connection connection = Connection.getInstance();
        if (!msgText.isEmpty()) {
            ///Add message to live
            ChatMessage chatMsg = new ChatMessage(receiver, msgText, true,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        chatMessagesAdapter = new ChatMessagesAdapter(getActivity(), chatList);
        ...
        Button sendMsgButton = (Button) view.findViewById(R.id.send_message_button);

...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("lock_screen"),"boolean");
            bindPreferenceSummaryToValue(findPreference("cloud_storage"),"boolean");
            bindPreferenceSummaryToValue(findPreference("display_name"),"String");
        }
